...
const TEMPLATES: Record<RecoveryEventType, string> = {
  ...
  recovery_message_delivered: "Mensagem entregue ao cliente",
  recovery_message_read: "Mensagem visualizada pelo cliente",
  recovery_delivery_failed: "A operadora não conseguiu entregar a mensagem",
