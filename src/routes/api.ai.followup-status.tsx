// ============================================================================
// /api/ai/followup-status — status WhatsApp + score summary + alertas.
// Camada nova; não toca rotas existentes.
// ============================================================================
...
export const Route = createFileRoute("/api/ai/followup-status")({
  server: {
    handlers: {
      GET: async ({ request }: { request: Request }) => {
        ...
        const [whatsapp, temps, gate, analytics] = await Promise.all([
