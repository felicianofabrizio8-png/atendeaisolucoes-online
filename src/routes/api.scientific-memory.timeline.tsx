// ============================================================================
// GET /api/scientific-memory/timeline
// Admin-only. READ-ONLY. Últimos 365 dias da Memória Científica.
// ============================================================================
...
export const Route = createFileRoute("/api/scientific-memory/timeline")({
  server: {
    handlers: {
      ...
      GET: async ({ request }: { request: Request }) => {
        try {
          ...
          const items = await agent.timeline(parsed.data.period);

          return json(200, { ok: true, data: { items, count: items.length } });
        } catch {
