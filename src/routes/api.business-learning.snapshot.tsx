...
// Admin-only. READ-ONLY. Retorna { generatedAt, evolution, hypotheses, learning }.
// Consome apenas Business Brain + Executive Knowledge. Sem LLM, sem PII.
// ============================================================================
...
export const Route = createFileRoute("/api/business-learning/snapshot")({
  server: {
    handlers: {
      ...
      GET: async ({ request }: { request: Request }) => {
        try {
          ...
          const agent = new BusinessLearningAgent({
            supabase,
          ...
          return json(200, {
            ...
            data: {
              ...
              // metadados úteis para o consumidor humano:
              period: snapshot.period,
              learningVersion: snapshot.learningVersion,
